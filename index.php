...
if (isset($_POST['email']) && !empty($_POST['email'])) {
    ...
    if (!is_null($email)) {
        ...
        $query = mysqli_query($connection, "SELECT * FROM `admins` WHERE `email` = '$email' AND `password` = '$password'");
        ...
        echo 'Sorry Email Or Password Not Valid!!!';
    }
...
<div class="login-box">
    ...
    <div class="card card-outline card-primary">
        <div class="card-header text-center">
            <a href="design//index2.html" class="h1"><b>Admin</b>LTE</a>
        </div>
        <div class="card-body">
